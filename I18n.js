...
var panelHelpCatalogs = {
  en: ["Panel hints", "Hints will turn off after {remaining} more hovers.\nClick to hide them now. You can always turn them on again", "Show panel hints on hover\nClick to turn off", "Show panel hints on hover\nClick to turn on", "Ctrl + click: to this workspace", "Hints will turn off after {remaining} more hover.\nClick to hide them now. You can always turn them on again"],
  pl: ["Podpowiedzi w panelu", "Podpowiedzi wyłączą się po kolejnych {remaining} wyświetleniach.\nKliknij, aby je teraz ukryć. Zawsze możesz włączyć je ponownie", "Pokazuj podpowiedzi w panelu po najechaniu\nKliknij, aby wyłączyć", "Pokazuj podpowiedzi w panelu po najechaniu\nKliknij, aby włączyć", "Ctrl + klik: na ten obszar roboczy", "Podpowiedzi wyłączą się po jeszcze {remaining} wyświetleniu.\nKliknij, aby je teraz ukryć. Zawsze możesz włączyć je ponownie"],
  de: ["Hinweise im Panel", "Hinweise werden nach weiteren {remaining} Anzeigen ausgeschaltet.\nKlicken, um sie jetzt auszublenden. Du kannst sie jederzeit wieder einschalten", "Panel-Hinweise beim Darüberfahren anzeigen\nZum Ausschalten klicken", "Panel-Hinweise beim Darüberfahren anzeigen\nZum Einschalten klicken", "Strg + Klick: auf diesen Arbeitsbereich", "Hinweise werden nach {remaining} weiteren Anzeige ausgeschaltet.\nKlicken, um sie jetzt auszublenden. Du kannst sie jederzeit wieder einschalten"],
  fr: ["Aide du panneau", "Les aides seront désactivées après {remaining} affichages.\nCliquez pour les masquer maintenant. Vous pouvez toujours les réactiver", "Afficher l’aide du panneau au survol\nCliquez pour désactiver", "Afficher l’aide du panneau au survol\nCliquez pour activer", "Ctrl + clic : vers cet espace de travail", "Les aides seront désactivées après {remaining} affichage.\nCliquez pour les masquer maintenant. Vous pouvez toujours les réactiver"],
  es: ["Ayuda del panel", "Las ayudas se desactivarán tras {remaining} apariciones más.\nHaz clic para ocultarlas ahora. Siempre puedes volver a activarlas", "Mostrar ayuda del panel al pasar el cursor\nHaz clic para desactivar", "Mostrar ayuda del panel al pasar el cursor\nHaz clic para activar", "Ctrl + clic: a este espacio de trabajo", "Las ayudas se desactivarán tras {remaining} aparición más.\nHaz clic para ocultarlas ahora. Siempre puedes volver a activarlas"],
  "pt-BR": ["Dicas do painel", "As dicas serão desativadas após mais {remaining} exibições.\nClique para ocultá-las agora. Você sempre pode ativá-las novamente", "Mostrar dicas do painel ao passar o cursor\nClique para desativar", "Mostrar dicas do painel ao passar o cursor\nClique para ativar", "Ctrl + clique: para esta área de trabalho", "As dicas serão desativadas após mais {remaining} exibição.\nClique para ocultá-las agora. Você sempre pode ativá-las novamente"],
  "pt-PT": ["Dicas do painel", "As dicas serão desativadas após mais {remaining} exibições.\nClique para as ocultar agora. Pode sempre voltar a ativá-las", "Mostrar dicas do painel ao passar o cursor\nClique para desativar", "Mostrar dicas do painel ao passar o cursor\nClique para ativar", "Ctrl + clique: para esta área de trabalho", "As dicas serão desativadas após mais {remaining} exibição.\nClique para as ocultar agora. Pode sempre voltar a ativá-las"],
  it: ["Suggerimenti del pannello", "I suggerimenti si disattiveranno dopo altre {remaining} visualizzazioni.\nFai clic per nasconderli ora. Puoi sempre riattivarli", "Mostra suggerimenti al passaggio del cursore\nFai clic per disattivare", "Mostra suggerimenti al passaggio del cursore\nFai clic per attivare", "Ctrl + clic: in questo spazio di lavoro", "I suggerimenti si disattiveranno dopo un’altra {remaining} visualizzazione.\nFai clic per nasconderli ora. Puoi sempre riattivarli"],
  nl: ["Paneeltips", "Tips worden na nog {remaining} weergaven uitgeschakeld.\nKlik om ze nu te verbergen. Je kunt ze altijd weer inschakelen", "Paneeltips tonen bij aanwijzen\nKlik om uit te schakelen", "Paneeltips tonen bij aanwijzen\nKlik om in te schakelen", "Ctrl + klik: naar deze werkruimte", "Tips worden na nog {remaining} weergave uitgeschakeld.\nKlik om ze nu te verbergen. Je kunt ze altijd weer inschakelen"],
  sv: ["Paneltips", "Tips stängs av efter ytterligare {remaining} visningar.\nKlicka för att dölja dem nu. Du kan alltid slå på dem igen", "Visa paneltips när pekaren hålls över\nKlicka för att stänga av", "Visa paneltips när pekaren hålls över\nKlicka för att slå på", "Ctrl + klick: till denna arbetsyta", "Tips stängs av efter ytterligare {remaining} visning.\nKlicka för att dölja dem nu. Du kan alltid slå på dem igen"],
  da: ["Paneltip", "Tip slås fra efter yderligere {remaining} visninger.\nKlik for at skjule dem nu. Du kan altid slå dem til igen", "Vis paneltip, når markøren holdes over\nKlik for at slå fra", "Vis paneltip, når markøren holdes over\nKlik for at slå til", "Ctrl + klik: til dette arbejdsområde", "Tip slås fra efter yderligere {remaining} visning.\nKlik for at skjule dem nu. Du kan altid slå dem til igen"],
  nb: ["Paneltips", "Tips slås av etter ytterligere {remaining} visninger.\nKlikk for å skjule dem nå. Du kan alltid slå dem på igjen", "Vis paneltips når pekeren holdes over\nKlikk for å slå av", "Vis paneltips når pekeren holdes over\nKlikk for å slå på", "Ctrl + klikk: til dette arbeidsområdet", "Tips slås av etter ytterligere {remaining} visning.\nKlikk for å skjule dem nå. Du kan alltid slå dem på igjen"],
  fi: ["Paneelin vihjeet", "Vihjeet poistuvat käytöstä vielä {remaining} näyttökerran jälkeen.\nPiilota ne nyt napsauttamalla. Voit aina ottaa ne uudelleen käyttöön", "Näytä paneelin vihjeet osoitettaessa\nPoista käytöstä napsauttamalla", "Näytä paneelin vihjeet osoitettaessa\nOta käyttöön napsauttamalla", "Ctrl + napsautus: tähän työtilaan", "Vihjeet poistuvat käytöstä vielä {remaining} näyttökerran jälkeen.\nPiilota ne nyt napsauttamalla. Voit aina ottaa ne uudelleen käyttöön"],
  cs: ["Nápovědy panelu", "Zbývající zobrazení nápověd do automatického vypnutí: {remaining}.\nKliknutím je nyní skryjete. Vždy je můžete znovu zapnout", "Zobrazovat nápovědy panelu při najetí\nKliknutím vypnete", "Zobrazovat nápovědy panelu při najetí\nKliknutím zapnete", "Ctrl + kliknutí: na tuto plochu", "Zbývající zobrazení nápověd do automatického vypnutí: {remaining}.\nKliknutím je nyní skryjete. Vždy je můžete znovu zapnout"],
  sk: ["Tipy panela", "Zostávajúce zobrazenia tipov do automatického vypnutia: {remaining}.\nKliknutím ich teraz skryjete. Vždy ich môžete znova zapnúť", "Zobrazovať tipy panela pri ukázaní\nKliknutím vypnete", "Zobrazovať tipy panela pri ukázaní\nKliknutím zapnete", "Ctrl + kliknutie: na túto plochu", "Zostávajúce zobrazenia tipov do automatického vypnutia: {remaining}.\nKliknutím ich teraz skryjete. Vždy ich môžete znova zapnúť"],
  uk: ["Підказки панелі", "Показів підказок до автоматичного вимкнення: {remaining}.\nНатисніть, щоб приховати їх зараз. Ви завжди можете ввімкнути їх знову", "Показувати підказки панелі при наведенні\nНатисніть, щоб вимкнути", "Показувати підказки панелі при наведенні\nНатисніть, щоб увімкнути", "Ctrl + клацання: у цей робочий простір", "Показів підказок до автоматичного вимкнення: {remaining}.\nНатисніть, щоб приховати їх зараз. Ви завжди можете ввімкнути їх знову"],
  ru: ["Подсказки панели", "Показов подсказок до автоматического отключения: {remaining}.\nНажмите, чтобы скрыть их сейчас. Вы всегда можете включить их снова", "Показывать подсказки панели при наведении\nНажмите, чтобы выключить", "Показывать подсказки панели при наведении\nНажмите, чтобы включить", "Ctrl + щелчок: в это рабочее пространство", "Показов подсказок до автоматического отключения: {remaining}.\nНажмите, чтобы скрыть их сейчас. Вы всегда можете включить их снова"],
  tr: ["Panel ipuçları", "İpuçları {remaining} gösterim daha sonra kapanacak.\nŞimdi gizlemek için tıklayın. İstediğiniz zaman tekrar açabilirsiniz", "İmleç üzerindeyken panel ipuçlarını göster\nKapatmak için tıklayın", "İmleç üzerindeyken panel ipuçlarını göster\nAçmak için tıklayın", "Ctrl + tıklama: bu çalışma alanına", "İpuçları {remaining} gösterim daha sonra kapanacak.\nŞimdi gizlemek için tıklayın. İstediğiniz zaman tekrar açabilirsiniz"],
  ro: ["Indicații în panou", "Indicațiile se vor dezactiva după încă {remaining} afișări.\nClic pentru a le ascunde acum. Le poți reactiva oricând", "Arată indicații în panou la trecerea cursorului\nClic pentru dezactivare", "Arată indicații în panou la trecerea cursorului\nClic pentru activare", "Ctrl + clic: în acest spațiu de lucru", "Indicațiile se vor dezactiva după încă {remaining} afișare.\nClic pentru a le ascunde acum. Le poți reactiva oricând"],
  hu: ["Panelsúgók", "A súgók további {remaining} megjelenítés után kikapcsolnak.\nKattints az elrejtésükhöz. Bármikor újra bekapcsolhatod őket", "Panelsúgók megjelenítése rámutatáskor\nKattints a kikapcsoláshoz", "Panelsúgók megjelenítése rámutatáskor\nKattints a bekapcsoláshoz", "Ctrl + kattintás: erre a munkaterületre", "A súgók további {remaining} megjelenítés után kikapcsolnak.\nKattints az elrejtésükhöz. Bármikor újra bekapcsolhatod őket"],
  el: ["Συμβουλές πίνακα", "Οι συμβουλές θα απενεργοποιηθούν μετά από {remaining} ακόμη προβολές.\nΚλικ για απόκρυψη τώρα. Μπορείτε πάντα να τις ενεργοποιήσετε ξανά", "Εμφάνιση συμβουλών πίνακα κατά την κατάδειξη\nΚλικ για απενεργοποίηση", "Εμφάνιση συμβουλών πίνακα κατά την κατάδειξη\nΚλικ για ενεργοποίηση", "Ctrl + κλικ: σε αυτόν τον χώρο εργασίας", "Οι συμβουλές θα απενεργοποιηθούν μετά από {remaining} ακόμη προβολή.\nΚλικ για απόκρυψη τώρα. Μπορείτε πάντα να τις ενεργοποιήσετε ξανά"],
  ar: ["تلميحات اللوحة", "مرات ظهور التلميحات المتبقية قبل الإيقاف التلقائي: {remaining}.\nانقر لإخفائها الآن. يمكنك دائمًا تفعيلها مجددًا", "إظهار تلميحات اللوحة عند تمرير المؤشر\nانقر للإيقاف", "إظهار تلميحات اللوحة عند تمرير المؤشر\nانقر للتفعيل", "Ctrl + نقر: إلى مساحة العمل هذه", "مرات ظهور التلميحات المتبقية قبل الإيقاف التلقائي: {remaining}.\nانقر لإخفائها الآن. يمكنك دائمًا تفعيلها مجددًا"],
  hi: ["पैनल के सुझाव", "सुझाव {remaining} बार और दिखने के बाद बंद हो जाएँगे।\nअभी छिपाने के लिए क्लिक करें। आप इन्हें कभी भी फिर चालू कर सकते हैं", "होवर करने पर पैनल के सुझाव दिखाएँ\nबंद करने के लिए क्लिक करें", "होवर करने पर पैनल के सुझाव दिखाएँ\nचालू करने के लिए क्लिक करें", "Ctrl + क्लिक: इस कार्यक्षेत्र में", "सुझाव {remaining} बार और दिखने के बाद बंद हो जाएँगे।\nअभी छिपाने के लिए क्लिक करें। आप इन्हें कभी भी फिर चालू कर सकते हैं"],
  id: ["Petunjuk panel", "Petunjuk akan nonaktif setelah {remaining} tampilan lagi.\nKlik untuk menyembunyikannya sekarang. Anda selalu dapat mengaktifkannya lagi", "Tampilkan petunjuk panel saat kursor diarahkan\nKlik untuk menonaktifkan", "Tampilkan petunjuk panel saat kursor diarahkan\nKlik untuk mengaktifkan", "Ctrl + klik: ke ruang kerja ini", "Petunjuk akan nonaktif setelah {remaining} tampilan lagi.\nKlik untuk menyembunyikannya sekarang. Anda selalu dapat mengaktifkannya lagi"],
  vi: ["Gợi ý trong bảng", "Gợi ý sẽ tắt sau {remaining} lần hiển thị nữa.\nNhấp để ẩn ngay. Bạn luôn có thể bật lại", "Hiện gợi ý trong bảng khi di chuột lên\nNhấp để tắt", "Hiện gợi ý trong bảng khi di chuột lên\nNhấp để bật", "Ctrl + nhấp: đến không gian làm việc này", "Gợi ý sẽ tắt sau {remaining} lần hiển thị nữa.\nNhấp để ẩn ngay. Bạn luôn có thể bật lại"],
  th: ["คำแนะนำในแผง", "คำแนะนำจะปิดหลังจากแสดงอีก {remaining} ครั้ง\nคลิกเพื่อซ่อนตอนนี้ คุณสามารถเปิดอีกครั้งได้เสมอ", "แสดงคำแนะนำในแผงเมื่อวางเมาส์เหนือ\nคลิกเพื่อปิด", "แสดงคำแนะนำในแผงเมื่อวางเมาส์เหนือ\nคลิกเพื่อเปิด", "Ctrl + คลิก: ไปยังพื้นที่ทำงานนี้", "คำแนะนำจะปิดหลังจากแสดงอีก {remaining} ครั้ง\nคลิกเพื่อซ่อนตอนนี้ คุณสามารถเปิดอีกครั้งได้เสมอ"],
  ja: ["パネルのヒント", "ヒントはあと{remaining}回表示されると無効になります。\nクリックで今すぐ非表示にします。いつでも再び有効にできます", "ホバー時にパネルのヒントを表示\nクリックで無効にする", "ホバー時にパネルのヒントを表示\nクリックで有効にする", "Ctrl + クリック：このワークスペースへ", "ヒントはあと{remaining}回表示されると無効になります。\nクリックで今すぐ非表示にします。いつでも再び有効にできます"],
  ko: ["패널 도움말", "도움말이 {remaining}회 더 표시된 후 꺼집니다.\n클릭하여 지금 숨기세요. 언제든 다시 켤 수 있습니다", "마우스를 올리면 패널 도움말 표시\n클릭하여 끄기", "마우스를 올리면 패널 도움말 표시\n클릭하여 켜기", "Ctrl + 클릭: 이 작업 공간으로", "도움말이 {remaining}회 더 표시된 후 꺼집니다.\n클릭하여 지금 숨기세요. 언제든 다시 켤 수 있습니다"],
  "zh-CN": ["面板提示", "提示再显示 {remaining} 次后将自动关闭。\n点击立即隐藏。你随时可以重新开启", "悬停时显示面板提示\n点击关闭", "悬停时显示面板提示\n点击开启", "Ctrl + 点击：移到此工作区", "提示再显示 {remaining} 次后将自动关闭。\n点击立即隐藏。你随时可以重新开启"],
  "zh-TW": ["面板提示", "提示再顯示 {remaining} 次後將自動關閉。\n點擊立即隱藏。你隨時可以重新開啟", "懸停時顯示面板提示\n點擊關閉", "懸停時顯示面板提示\n點擊開啟", "Ctrl + 點擊：移到此工作區", "提示再顯示 {remaining} 次後將自動關閉。\n點擊立即隱藏。你隨時可以重新開啟"]
};
