...
var panelHelpCatalogs = {
  en: ["Panel hints", "Hints on hover will automatically turn off after {days} days.\nClick to turn them off now", "Show panel hints on hover\nClick to turn off", "Show panel hints on hover\nClick to turn on", "Ctrl+click: to this workspace", "Hints on hover will automatically turn off after {days} day.\nClick to turn them off now"],
  pl: ["Podpowiedzi w panelu", "Podpowiedzi wyłączą się automatycznie za {days} dni.\nKliknij, aby wyłączyć je teraz", "Pokazuj podpowiedzi w panelu po najechaniu\nKliknij, aby wyłączyć", "Pokazuj podpowiedzi w panelu po najechaniu\nKliknij, aby włączyć", "Ctrl+klik: na ten obszar roboczy", "Podpowiedzi wyłączą się automatycznie za {days} dzień.\nKliknij, aby wyłączyć je teraz"],
  de: ["Hinweise im Panel", "Hover-Hinweise werden nach {days} Tagen automatisch ausgeschaltet.\nKlicken, um sie jetzt auszuschalten", "Panel-Hinweise beim Darüberfahren anzeigen\nZum Ausschalten klicken", "Panel-Hinweise beim Darüberfahren anzeigen\nZum Einschalten klicken", "Strg+Klick: auf diesen Arbeitsbereich", "Hover-Hinweise werden nach {days} Tag automatisch ausgeschaltet.\nKlicken, um sie jetzt auszuschalten"],
  fr: ["Aide du panneau", "Les infobulles seront désactivées automatiquement dans {days} jours.\nCliquez pour les désactiver maintenant", "Afficher l’aide du panneau au survol\nCliquez pour désactiver", "Afficher l’aide du panneau au survol\nCliquez pour activer", "Ctrl+clic : vers cet espace de travail", "Les infobulles seront désactivées automatiquement dans {days} jour.\nCliquez pour les désactiver maintenant"],
  es: ["Ayuda del panel", "Las ayudas se desactivarán automáticamente en {days} días.\nHaz clic para desactivarlas ahora", "Mostrar ayuda del panel al pasar el cursor\nHaz clic para desactivar", "Mostrar ayuda del panel al pasar el cursor\nHaz clic para activar", "Ctrl+clic: a este espacio de trabajo", "Las ayudas se desactivarán automáticamente en {days} día.\nHaz clic para desactivarlas ahora"],
  "pt-BR": ["Dicas do painel", "As dicas serão desativadas automaticamente em {days} dias.\nClique para desativá-las agora", "Mostrar dicas do painel ao passar o cursor\nClique para desativar", "Mostrar dicas do painel ao passar o cursor\nClique para ativar", "Ctrl+clique: para esta área de trabalho", "As dicas serão desativadas automaticamente em {days} dia.\nClique para desativá-las agora"],
  "pt-PT": ["Dicas do painel", "As dicas serão desativadas automaticamente em {days} dias.\nClique para as desativar agora", "Mostrar dicas do painel ao passar o cursor\nClique para desativar", "Mostrar dicas do painel ao passar o cursor\nClique para ativar", "Ctrl+clique: para esta área de trabalho", "As dicas serão desativadas automaticamente em {days} dia.\nClique para as desativar agora"],
  it: ["Suggerimenti del pannello", "I suggerimenti si disattiveranno automaticamente tra {days} giorni.\nFai clic per disattivarli ora", "Mostra suggerimenti al passaggio del cursore\nFai clic per disattivare", "Mostra suggerimenti al passaggio del cursore\nFai clic per attivare", "Ctrl+clic: in questo spazio di lavoro", "I suggerimenti si disattiveranno automaticamente tra {days} giorno.\nFai clic per disattivarli ora"],
  nl: ["Paneeltips", "Tips worden over {days} dagen automatisch uitgeschakeld.\nKlik om ze nu uit te schakelen", "Paneeltips tonen bij aanwijzen\nKlik om uit te schakelen", "Paneeltips tonen bij aanwijzen\nKlik om in te schakelen", "Ctrl+klik: naar deze werkruimte", "Tips worden over {days} dag automatisch uitgeschakeld.\nKlik om ze nu uit te schakelen"],
  sv: ["Paneltips", "Tips stängs av automatiskt om {days} dagar.\nKlicka för att stänga av dem nu", "Visa paneltips när pekaren hålls över\nKlicka för att stänga av", "Visa paneltips när pekaren hålls över\nKlicka för att slå på", "Ctrl+klick: till denna arbetsyta", "Tips stängs av automatiskt om {days} dag.\nKlicka för att stänga av dem nu"],
  da: ["Paneltip", "Tip slås automatisk fra om {days} dage.\nKlik for at slå dem fra nu", "Vis paneltip, når markøren holdes over\nKlik for at slå fra", "Vis paneltip, når markøren holdes over\nKlik for at slå til", "Ctrl+klik: til dette arbejdsområde", "Tip slås automatisk fra om {days} dag.\nKlik for at slå dem fra nu"],
  nb: ["Paneltips", "Tips slås av automatisk om {days} dager.\nKlikk for å slå dem av nå", "Vis paneltips når pekeren holdes over\nKlikk for å slå av", "Vis paneltips når pekeren holdes over\nKlikk for å slå på", "Ctrl+klikk: til dette arbeidsområdet", "Tips slås av automatisk om {days} dag.\nKlikk for å slå dem av nå"],
  fi: ["Paneelin vihjeet", "Vihjeet poistuvat käytöstä automaattisesti {days} päivän kuluttua.\nPoista ne käytöstä nyt napsauttamalla", "Näytä paneelin vihjeet osoitettaessa\nPoista käytöstä napsauttamalla", "Näytä paneelin vihjeet osoitettaessa\nOta käyttöön napsauttamalla", "Ctrl+napsautus: tähän työtilaan", "Vihjeet poistuvat käytöstä automaattisesti {days} päivän kuluttua.\nPoista ne käytöstä nyt napsauttamalla"],
  cs: ["Nápovědy panelu", "Automatické vypnutí nápověd za počet dní: {days}.\nKliknutím je vypnete hned", "Zobrazovat nápovědy panelu při najetí\nKliknutím vypnete", "Zobrazovat nápovědy panelu při najetí\nKliknutím zapnete", "Ctrl+kliknutí: na tuto plochu", "Nápovědy se automaticky vypnou za {days} den.\nKliknutím je vypnete hned"],
  sk: ["Tipy panela", "Automatické vypnutie tipov o počet dní: {days}.\nKliknutím ich vypnete teraz", "Zobrazovať tipy panela pri ukázaní\nKliknutím vypnete", "Zobrazovať tipy panela pri ukázaní\nKliknutím zapnete", "Ctrl+kliknutie: na túto plochu", "Tipy sa automaticky vypnú o {days} deň.\nKliknutím ich vypnete teraz"],
  uk: ["Підказки панелі", "До автоматичного вимкнення підказок залишилося днів: {days}.\nНатисніть, щоб вимкнути їх зараз", "Показувати підказки панелі при наведенні\nНатисніть, щоб вимкнути", "Показувати підказки панелі при наведенні\nНатисніть, щоб увімкнути", "Ctrl+клацання: у цей робочий простір", "Підказки автоматично вимкнуться через {days} день.\nНатисніть, щоб вимкнути їх зараз"],
  ru: ["Подсказки панели", "До автоматического отключения подсказок осталось дней: {days}.\nНажмите, чтобы выключить их сейчас", "Показывать подсказки панели при наведении\nНажмите, чтобы выключить", "Показывать подсказки панели при наведении\nНажмите, чтобы включить", "Ctrl+щелчок: в это рабочее пространство", "Подсказки автоматически отключатся через {days} день.\nНажмите, чтобы выключить их сейчас"],
  tr: ["Panel ipuçları", "İpuçları {days} gün sonra otomatik olarak kapanacak.\nŞimdi kapatmak için tıklayın", "İmleç üzerindeyken panel ipuçlarını göster\nKapatmak için tıklayın", "İmleç üzerindeyken panel ipuçlarını göster\nAçmak için tıklayın", "Ctrl+tıklama: bu çalışma alanına", "İpuçları {days} gün sonra otomatik olarak kapanacak.\nŞimdi kapatmak için tıklayın"],
  ro: ["Indicații în panou", "Indicațiile se vor dezactiva automat peste {days} zile.\nClic pentru a le dezactiva acum", "Arată indicații în panou la trecerea cursorului\nClic pentru dezactivare", "Arată indicații în panou la trecerea cursorului\nClic pentru activare", "Ctrl+clic: în acest spațiu de lucru", "Indicațiile se vor dezactiva automat peste {days} zi.\nClic pentru a le dezactiva acum"],
  hu: ["Panelsúgók", "A súgók {days} nap múlva automatikusan kikapcsolnak.\nKattints az azonnali kikapcsoláshoz", "Panelsúgók megjelenítése rámutatáskor\nKattints a kikapcsoláshoz", "Panelsúgók megjelenítése rámutatáskor\nKattints a bekapcsoláshoz", "Ctrl+kattintás: erre a munkaterületre", "A súgók {days} nap múlva automatikusan kikapcsolnak.\nKattints az azonnali kikapcsoláshoz"],
  el: ["Συμβουλές πίνακα", "Οι συμβουλές θα απενεργοποιηθούν αυτόματα σε {days} ημέρες.\nΚλικ για απενεργοποίηση τώρα", "Εμφάνιση συμβουλών πίνακα κατά την κατάδειξη\nΚλικ για απενεργοποίηση", "Εμφάνιση συμβουλών πίνακα κατά την κατάδειξη\nΚλικ για ενεργοποίηση", "Ctrl+κλικ: σε αυτόν τον χώρο εργασίας", "Οι συμβουλές θα απενεργοποιηθούν αυτόματα σε {days} ημέρα.\nΚλικ για απενεργοποίηση τώρα"],
  ar: ["تلميحات اللوحة", "تتوقف التلميحات تلقائيًا بعد {days} أيام.\nانقر لإيقافها الآن", "إظهار تلميحات اللوحة عند تمرير المؤشر\nانقر للإيقاف", "إظهار تلميحات اللوحة عند تمرير المؤشر\nانقر للتفعيل", "Ctrl+نقر: إلى مساحة العمل هذه", "تتوقف التلميحات تلقائيًا بعد {days} يوم.\nانقر لإيقافها الآن"],
  hi: ["पैनल के सुझाव", "होवर सुझाव {days} दिनों के बाद अपने आप बंद हो जाएँगे।\nअभी बंद करने के लिए क्लिक करें", "होवर करने पर पैनल के सुझाव दिखाएँ\nबंद करने के लिए क्लिक करें", "होवर करने पर पैनल के सुझाव दिखाएँ\nचालू करने के लिए क्लिक करें", "Ctrl+क्लिक: इस कार्यक्षेत्र में", "होवर सुझाव {days} दिन के बाद अपने आप बंद हो जाएँगे।\nअभी बंद करने के लिए क्लिक करें"],
  id: ["Petunjuk panel", "Petunjuk akan nonaktif otomatis setelah {days} hari.\nKlik untuk menonaktifkannya sekarang", "Tampilkan petunjuk panel saat kursor diarahkan\nKlik untuk menonaktifkan", "Tampilkan petunjuk panel saat kursor diarahkan\nKlik untuk mengaktifkan", "Ctrl+klik: ke ruang kerja ini", "Petunjuk akan nonaktif otomatis setelah {days} hari.\nKlik untuk menonaktifkannya sekarang"],
  vi: ["Gợi ý trong bảng", "Gợi ý sẽ tự tắt sau {days} ngày.\nNhấp để tắt ngay", "Hiện gợi ý trong bảng khi di chuột lên\nNhấp để tắt", "Hiện gợi ý trong bảng khi di chuột lên\nNhấp để bật", "Ctrl+nhấp: đến không gian làm việc này", "Gợi ý sẽ tự tắt sau {days} ngày.\nNhấp để tắt ngay"],
  th: ["คำแนะนำในแผง", "คำแนะนำจะปิดอัตโนมัติในอีก {days} วัน\nคลิกเพื่อปิดตอนนี้", "แสดงคำแนะนำในแผงเมื่อวางเมาส์เหนือ\nคลิกเพื่อปิด", "แสดงคำแนะนำในแผงเมื่อวางเมาส์เหนือ\nคลิกเพื่อเปิด", "Ctrl+คลิก: ไปยังพื้นที่ทำงานนี้", "คำแนะนำจะปิดอัตโนมัติในอีก {days} วัน\nคลิกเพื่อปิดตอนนี้"],
  ja: ["パネルのヒント", "ホバー時のヒントは{days}日後に自動で無効になります。\nクリックで今すぐ無効にする", "ホバー時にパネルのヒントを表示\nクリックで無効にする", "ホバー時にパネルのヒントを表示\nクリックで有効にする", "Ctrl+クリック：このワークスペースへ", "ホバー時のヒントは{days}日後に自動で無効になります。\nクリックで今すぐ無効にする"],
  ko: ["패널 도움말", "마우스 오버 도움말이 {days}일 후 자동으로 꺼집니다.\n클릭하여 지금 끄기", "마우스를 올리면 패널 도움말 표시\n클릭하여 끄기", "마우스를 올리면 패널 도움말 표시\n클릭하여 켜기", "Ctrl+클릭: 이 작업 공간으로", "마우스 오버 도움말이 {days}일 후 자동으로 꺼집니다.\n클릭하여 지금 끄기"],
  "zh-CN": ["面板提示", "悬停提示将在 {days} 天后自动关闭。\n点击立即关闭", "悬停时显示面板提示\n点击关闭", "悬停时显示面板提示\n点击开启", "Ctrl+点击：移到此工作区", "悬停提示将在 {days} 天后自动关闭。\n点击立即关闭"],
  "zh-TW": ["面板提示", "懸停提示將在 {days} 天後自動關閉。\n點擊立即關閉", "懸停時顯示面板提示\n點擊關閉", "懸停時顯示面板提示\n點擊開啟", "Ctrl+點擊：移到此工作區", "懸停提示將在 {days} 天後自動關閉。\n點擊立即關閉"]
};
