...
var transferCatalogs = {
  en: ["Add window…", "Take out of scratchpad…", "Destination workspace", "Current", "Workspace {workspace}", "Move", "Moving…", "Moves only this window, without switching workspaces.", "Could not move this window. It may have closed, moved or remained grouped. Try again."],
  pl: ["Dodaj okno…", "Wyciągnij ze scratchpada…", "Docelowy workspace", "Bieżący", "Workspace {workspace}", "Przenieś", "Przenoszenie…", "Przenosi tylko to okno, bez przełączania workspace’u.", "Nie udało się przenieść okna. Mogło zostać zamknięte, przeniesione lub pozostać w grupie. Spróbuj ponownie."],
  de: ["Fenster hinzufügen…", "Aus Scratchpad holen…", "Zielarbeitsfläche", "Aktuell", "Arbeitsfläche {workspace}", "Verschieben", "Verschieben…", "Verschiebt nur dieses Fenster, ohne die Arbeitsfläche zu wechseln.", "Fenster konnte nicht verschoben werden. Es wurde möglicherweise geschlossen, verschoben oder blieb gruppiert. Erneut versuchen."],
  fr: ["Ajouter une fenêtre…", "Sortir du scratchpad…", "Espace de travail cible", "Actuel", "Espace {workspace}", "Déplacer", "Déplacement…", "Déplace uniquement cette fenêtre, sans changer d’espace de travail.", "Impossible de déplacer la fenêtre. Elle a peut-être été fermée, déplacée ou est restée groupée. Réessayez."],
  es: ["Añadir ventana…", "Sacar del scratchpad…", "Espacio de destino", "Actual", "Espacio {workspace}", "Mover", "Moviendo…", "Mueve solo esta ventana, sin cambiar de espacio de trabajo.", "No se pudo mover la ventana. Puede haberse cerrado, movido o seguir agrupada. Inténtalo de nuevo."],
  "pt-BR": ["Adicionar janela…", "Retirar do scratchpad…", "Área de trabalho de destino", "Atual", "Área {workspace}", "Mover", "Movendo…", "Move apenas esta janela, sem trocar de área de trabalho.", "Não foi possível mover a janela. Ela pode ter sido fechada, movida ou permanecido agrupada. Tente novamente."],
  "pt-PT": ["Adicionar janela…", "Retirar do scratchpad…", "Área de trabalho de destino", "Atual", "Área {workspace}", "Mover", "A mover…", "Move apenas esta janela, sem mudar de área de trabalho.", "Não foi possível mover a janela. Pode ter sido fechada, movida ou permanecido agrupada. Tente novamente."],
  it: ["Aggiungi finestra…", "Estrai dallo scratchpad…", "Spazio di lavoro di destinazione", "Attuale", "Spazio {workspace}", "Sposta", "Spostamento…", "Sposta solo questa finestra, senza cambiare spazio di lavoro.", "Impossibile spostare la finestra. Potrebbe essere chiusa, spostata o ancora raggruppata. Riprova."],
  nl: ["Venster toevoegen…", "Uit scratchpad halen…", "Doelwerkruimte", "Huidig", "Werkruimte {workspace}", "Verplaatsen", "Verplaatsen…", "Verplaatst alleen dit venster, zonder van werkruimte te wisselen.", "Venster kon niet worden verplaatst. Het is mogelijk gesloten, verplaatst of nog gegroepeerd. Probeer opnieuw."],
  sv: ["Lägg till fönster…", "Ta ut ur scratchpad…", "Målarbetsyta", "Aktuell", "Arbetsyta {workspace}", "Flytta", "Flyttar…", "Flyttar bara detta fönster utan att byta arbetsyta.", "Kunde inte flytta fönstret. Det kan ha stängts, flyttats eller förblivit grupperat. Försök igen."],
  da: ["Tilføj vindue…", "Tag ud af scratchpad…", "Målarbejdsområde", "Aktuelt", "Arbejdsområde {workspace}", "Flyt", "Flytter…", "Flytter kun dette vindue uden at skifte arbejdsområde.", "Vinduet kunne ikke flyttes. Det kan være lukket, flyttet eller stadig grupperet. Prøv igen."],
  nb: ["Legg til vindu…", "Ta ut av scratchpad…", "Målarbeidsområde", "Gjeldende", "Arbeidsområde {workspace}", "Flytt", "Flytter…", "Flytter bare dette vinduet uten å bytte arbeidsområde.", "Kunne ikke flytte vinduet. Det kan være lukket, flyttet eller fortsatt gruppert. Prøv igjen."],
  fi: ["Lisää ikkuna…", "Poista scratchpadista…", "Kohdetyötila", "Nykyinen", "Työtila {workspace}", "Siirrä", "Siirretään…", "Siirtää vain tämän ikkunan vaihtamatta työtilaa.", "Ikkunaa ei voitu siirtää. Se on ehkä suljettu, siirretty tai yhä ryhmässä. Yritä uudelleen."],
  cs: ["Přidat okno…", "Vyjmout ze scratchpadu…", "Cílová plocha", "Aktuální", "Plocha {workspace}", "Přesunout", "Přesouvání…", "Přesune pouze toto okno bez přepnutí plochy.", "Okno nelze přesunout. Mohlo být zavřeno, přesunuto nebo zůstalo ve skupině. Zkuste to znovu."],
  sk: ["Pridať okno…", "Vybrať zo scratchpadu…", "Cieľová plocha", "Aktuálna", "Plocha {workspace}", "Presunúť", "Presúvanie…", "Presunie iba toto okno bez prepnutia plochy.", "Okno sa nepodarilo presunúť. Mohlo byť zatvorené, presunuté alebo zostalo v skupine. Skúste znova."],
  uk: ["Додати вікно…", "Витягти зі scratchpad…", "Цільовий робочий простір", "Поточний", "Простір {workspace}", "Перемістити", "Переміщення…", "Переміщує лише це вікно, не перемикаючи робочий простір.", "Не вдалося перемістити вікно. Його могли закрити, перемістити або воно залишилося в групі. Спробуйте ще раз."],
  ru: ["Добавить окно…", "Извлечь из scratchpad…", "Целевое рабочее пространство", "Текущее", "Пространство {workspace}", "Переместить", "Перемещение…", "Перемещает только это окно без переключения рабочего пространства.", "Не удалось переместить окно. Оно могло закрыться, переместиться или остаться в группе. Попробуйте ещё раз."],
  tr: ["Pencere ekle…", "Scratchpad’den çıkar…", "Hedef çalışma alanı", "Geçerli", "Çalışma alanı {workspace}", "Taşı", "Taşınıyor…", "Çalışma alanını değiştirmeden yalnızca bu pencereyi taşır.", "Pencere taşınamadı. Kapanmış, taşınmış veya grupta kalmış olabilir. Tekrar deneyin."],
  ro: ["Adaugă fereastră…", "Scoate din scratchpad…", "Spațiu de lucru destinație", "Curent", "Spațiul {workspace}", "Mută", "Se mută…", "Mută doar această fereastră, fără a schimba spațiul de lucru.", "Fereastra nu a putut fi mutată. Poate fi închisă, mutată sau încă grupată. Încearcă din nou."],
  hu: ["Ablak hozzáadása…", "Kivétel a scratchpadből…", "Célmunkaterület", "Jelenlegi", "Munkaterület: {workspace}", "Áthelyezés", "Áthelyezés…", "Csak ezt az ablakot helyezi át, munkaterületváltás nélkül.", "Az ablak nem helyezhető át. Lehet, hogy bezárták, áthelyezték, vagy csoportban maradt. Próbáld újra."],
  el: ["Προσθήκη παραθύρου…", "Εξαγωγή από το scratchpad…", "Χώρος εργασίας προορισμού", "Τρέχων", "Χώρος {workspace}", "Μετακίνηση", "Μετακίνηση…", "Μετακινεί μόνο αυτό το παράθυρο, χωρίς αλλαγή χώρου εργασίας.", "Αδυναμία μετακίνησης. Το παράθυρο ίσως έκλεισε, μετακινήθηκε ή παρέμεινε σε ομάδα. Δοκιμάστε ξανά."],
  ar: ["إضافة نافذة…", "إخراج من scratchpad…", "مساحة العمل الوجهة", "الحالية", "مساحة العمل ⁦{workspace}⁩", "نقل", "جارٍ النقل…", "ينقل هذه النافذة فقط دون تبديل مساحة العمل.", "تعذر نقل النافذة. ربما أُغلقت أو نُقلت أو بقيت ضمن مجموعة. حاول مجددًا."],
  hi: ["विंडो जोड़ें…", "Scratchpad से निकालें…", "लक्ष्य कार्यक्षेत्र", "वर्तमान", "कार्यक्षेत्र {workspace}", "ले जाएँ", "ले जा रहे हैं…", "कार्यक्षेत्र बदले बिना केवल इस विंडो को ले जाता है।", "विंडो को नहीं ले जा सके। वह बंद हो गई, स्थानांतरित हो गई या समूह में रह गई होगी। फिर प्रयास करें।"],
  id: ["Tambah jendela…", "Keluarkan dari scratchpad…", "Ruang kerja tujuan", "Saat ini", "Ruang kerja {workspace}", "Pindahkan", "Memindahkan…", "Memindahkan hanya jendela ini tanpa beralih ruang kerja.", "Jendela tidak dapat dipindahkan. Mungkin sudah ditutup, dipindahkan, atau masih dalam grup. Coba lagi."],
  vi: ["Thêm cửa sổ…", "Lấy ra khỏi scratchpad…", "Không gian làm việc đích", "Hiện tại", "Không gian {workspace}", "Di chuyển", "Đang chuyển…", "Chỉ di chuyển cửa sổ này, không đổi không gian làm việc.", "Không thể di chuyển cửa sổ. Có thể cửa sổ đã đóng, đã chuyển hoặc vẫn ở trong nhóm. Hãy thử lại."],
  th: ["เพิ่มหน้าต่าง…", "นำออกจาก scratchpad…", "พื้นที่ทำงานปลายทาง", "ปัจจุบัน", "พื้นที่ทำงาน {workspace}", "ย้าย", "กำลังย้าย…", "ย้ายเฉพาะหน้าต่างนี้โดยไม่สลับพื้นที่ทำงาน", "ย้ายหน้าต่างไม่ได้ อาจถูกปิด ย้ายไปแล้ว หรือยังอยู่ในกลุ่ม โปรดลองอีกครั้ง"],
  ja: ["ウィンドウを追加…", "Scratchpadから取り出す…", "移動先のワークスペース", "現在", "ワークスペース {workspace}", "移動", "移動中…", "ワークスペースを切り替えず、このウィンドウだけを移動します。", "移動できませんでした。ウィンドウが閉じた、移動済み、またはグループ内のままの可能性があります。再試行してください。"],
  ko: ["창 추가…", "Scratchpad에서 꺼내기…", "대상 작업 공간", "현재", "작업 공간 {workspace}", "이동", "이동 중…", "작업 공간을 전환하지 않고 이 창만 이동합니다.", "창을 이동할 수 없습니다. 닫혔거나, 이미 이동했거나, 그룹에 남아 있을 수 있습니다. 다시 시도하세요."],
  "zh-CN": ["添加窗口…", "从 Scratchpad 移出…", "目标工作区", "当前", "工作区 {workspace}", "移动", "正在移动…", "仅移动此窗口，不切换工作区。", "无法移动窗口。它可能已关闭、已移动或仍在分组中。请重试。"],
  "zh-TW": ["新增視窗…", "從 Scratchpad 移出…", "目標工作區", "目前", "工作區 {workspace}", "移動", "正在移動…", "僅移動此視窗，不切換工作區。", "無法移動視窗。它可能已關閉、已移動或仍在群組中。請重試。"]
};
