...
// Explicit line breaks keep the button tooltip compact at every UI scale.
var visibilityHintKeys = ["hideScratchpadHint", "showScratchpadHint"];
var visibilityHintCatalogs = {
  en: ["Hide the scratchpad on this monitor.\nWindows stay in the scratchpad.", "Show the scratchpad on this monitor."],
  pl: ["Schowaj scratchpad na tym monitorze.\nOkna pozostaną w scratchpadzie.", "Pokaż scratchpad na tym monitorze."],
  de: ["Blende das Scratchpad auf diesem Monitor aus.\nDie Fenster bleiben im Scratchpad.", "Zeige das Scratchpad auf diesem Monitor."],
  fr: ["Masquer le scratchpad sur cet écran.\nLes fenêtres restent dans le scratchpad.", "Afficher le scratchpad sur cet écran."],
  es: ["Ocultar el scratchpad en este monitor.\nLas ventanas permanecen en el scratchpad.", "Mostrar el scratchpad en este monitor."],
  "pt-BR": ["Ocultar o scratchpad neste monitor.\nAs janelas permanecem no scratchpad.", "Mostrar o scratchpad neste monitor."],
  "pt-PT": ["Ocultar o scratchpad neste monitor.\nAs janelas permanecem no scratchpad.", "Mostrar o scratchpad neste monitor."],
  it: ["Nascondi lo scratchpad su questo monitor.\nLe finestre restano nello scratchpad.", "Mostra lo scratchpad su questo monitor."],
  nl: ["Verberg het scratchpad op deze monitor.\nDe vensters blijven in het scratchpad.", "Toon het scratchpad op deze monitor."],
  sv: ["Dölj scratchpad på denna skärm.\nFönstren finns kvar i scratchpad.", "Visa scratchpad på denna skärm."],
  da: ["Skjul scratchpad på denne skærm.\nVinduerne bliver i scratchpad.", "Vis scratchpad på denne skærm."],
  nb: ["Skjul scratchpad på denne skjermen.\nVinduene blir i scratchpad.", "Vis scratchpad på denne skjermen."],
  fi: ["Piilota scratchpad tällä näytöllä.\nIkkunat pysyvät scratchpadissa.", "Näytä scratchpad tällä näytöllä."],
  cs: ["Skrýt scratchpad na tomto monitoru.\nOkna zůstanou ve scratchpadu.", "Zobrazit scratchpad na tomto monitoru."],
  sk: ["Skryť scratchpad na tomto monitore.\nOkná zostanú v scratchpade.", "Zobraziť scratchpad na tomto monitore."],
  uk: ["Приховати scratchpad на цьому моніторі.\nВікна залишаться в scratchpad.", "Показати scratchpad на цьому моніторі."],
  ru: ["Скрыть scratchpad на этом мониторе.\nОкна останутся в scratchpad.", "Показать scratchpad на этом мониторе."],
  tr: ["Scratchpad’i bu monitörde gizle.\nPencereler scratchpad’de kalır.", "Scratchpad’i bu monitörde göster."],
  ro: ["Ascunde scratchpad pe acest monitor.\nFerestrele rămân în scratchpad.", "Arată scratchpad pe acest monitor."],
  hu: ["Scratchpad elrejtése ezen a monitoron.\nAz ablakok a scratchpadben maradnak.", "Scratchpad megjelenítése ezen a monitoron."],
  el: ["Απόκρυψη του scratchpad σε αυτή την οθόνη.\nΤα παράθυρα παραμένουν στο scratchpad.", "Εμφάνιση του scratchpad σε αυτή την οθόνη."],
  ar: ["إخفاء scratchpad على هذه الشاشة.\nتبقى النوافذ داخل scratchpad.", "إظهار scratchpad على هذه الشاشة."],
  hi: ["इस मॉनिटर पर scratchpad छिपाएँ।\nविंडो scratchpad में रहेंगी।", "इस मॉनिटर पर scratchpad दिखाएँ।"],
  id: ["Sembunyikan scratchpad di monitor ini.\nJendela tetap berada di scratchpad.", "Tampilkan scratchpad di monitor ini."],
  vi: ["Ẩn scratchpad trên màn hình này.\nCác cửa sổ vẫn ở trong scratchpad.", "Hiện scratchpad trên màn hình này."],
  th: ["ซ่อน scratchpad บนจอภาพนี้\nหน้าต่างยังคงอยู่ใน scratchpad", "แสดง scratchpad บนจอภาพนี้"],
  ja: ["このモニターのScratchpadを非表示にします。\nウィンドウはScratchpadに残ります。", "このモニターにScratchpadを表示します。"],
  ko: ["이 모니터에서 Scratchpad를 숨깁니다.\n창은 Scratchpad에 남아 있습니다.", "이 모니터에 Scratchpad를 표시합니다."],
  "zh-CN": ["在此显示器上隐藏 Scratchpad。\n窗口仍保留在 Scratchpad 中。", "在此显示器上显示 Scratchpad。"],
  "zh-TW": ["在此螢幕上隱藏 Scratchpad。\n視窗仍保留在 Scratchpad 中。", "在此螢幕上顯示 Scratchpad。"]
};
