...
// Keep only ScratchPeek preferences in an independent, durable user file.
QtObject {
  id: root
  readonly property string directory: (Quickshell.env("XDG_STATE_HOME") || Quickshell.env("HOME") + "/.local/state") + "/scratchpeek"
